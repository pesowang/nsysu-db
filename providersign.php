...
<body class="text-center">
    ...
    <main class="form-signin">
      <form action="providersign.php" method="post">
        <img class="mb-4" src="https://img.icons8.com/stickers/344/farmer-male.png" alt="" width="150">
        <h1 class="h3 mb-3 fw-normal">供應商登入頁</h1>
      <?php
      $username = "";  $password = "";
      // 取得表單欄位值
      ...
      if ($username != "" && $password != "") {
        ...
        $query = "SELECT * FROM PROVIDER WHERE PASS='".$password."' AND FID='".$username."'";
        //echo $query;
        ...
        if ( $total_records > 0 ) {
            // 成功登入, 指定Session變數
            $_SESSION["provider_login"] = $username;
            //$_SESSION["SQL"] = $sql;
            header("Location: providerman.php");
        } else {  // 登入失敗
            echo "<center><font color='red' size='5'>";
            echo "使用者名稱或密碼錯誤!<br/>";
            echo "</font>";
            $_SESSION["provider_login"] = false;
        }
